...
const (
	...
	tunStableModeDiagnostic   = "Stable mode only captures TCP and UDP/53 into transparent TUN without rewriting system DNS; QUIC/UDP 443 stays on the main route to preserve domestic direct access."
)
