import{D as p,n as e,I as V,p as z,C as B,aN as F,aO as G,d as E,aJ as H,i as n,aP as q,q as J,v as L,y as K,z as j,aQ as Q,ac as T}from"./index-CY5FxqKh.js";import{g as W}from"./Space-DVNryQSF.js";import{u as U}from"./Tag-DvxeXdCa.js";function M(t,h="default",d=[]){const{children:s}=t;if(s!==null&&typeof s=="object"&&!Array.isArray(s)){const i=s[h];if(typeof i=="function")return i()}return d}const X=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
